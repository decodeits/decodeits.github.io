...
$(window).scroll(function(){
  if($(this).scrollTop()>height/2.35) {
      $('#hero-area img').attr('src','/img/Common/Logo Black 1.png');
  }
  else {
      $('#hero-area img').attr('src','img/Common/Logo White11.png');
  }
})
...
$(window).scroll(function(){
  ...
  console.log(cl);
  $('#hero-area img').attr('src','img/Common/B.svg');
  } catch (error) {
    $('#hero-area img').attr('src','img/Common/W.svg');
  }
...
/* 
   ...
   /* free-demo
    ========================================================================== 
     ...
     $(window).scroll(function() {
       if ($(this).scrollTop() > offset) {
         $('.free-demo').fadeIn(400);
       } else {
         $('.free-demo').fadeOut(400);
       }
     });
 
     $('.free-demo').on('click',function(event) {
       event.preventDefault();
       $('html, body').animate({
         scrollTop: 0
       }, 600);
